...
var ASM_CONSTS = {
  4528068: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4528123: ($0) => { performance.now = function() { return $0; }; },  
 4528171: ($0) => { performance.now = function() { return $0; }; },  
 4528219: () => { performance.now = Module['emscripten_get_now_backup']; }
};
